...
**Work in progress**
  ...
  <ol>
    ...
    <li>A regularized profile-dependent diffusion framework for the p(x)-Laplacian</li>
  </ol>
...
_Auto-generated from **avcixm/academicprofile** — build `a82a07f` on 2026-08-20 18:54 UTC_
